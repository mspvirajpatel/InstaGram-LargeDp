//
//	EdgeFollowedBy.swift
//
//	Create by VirajPatel on 11/4/2017
...
class EdgeFollowedBy : NSObject, NSCoding{

	var count : Int! = 0
    var edges : [FollowersEdge]! = []
	...
	init(fromDictionary dictionary: [String:Any])
    {
        ...
        if let edgesArray = dictionary["edges"] as? [[String:Any]]{
            for dic in edgesArray{
                let value = FollowersEdge(fromDictionary: dic)
                edges.append(value)
            }
        }
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
        ...
        edges = aDecoder.decodeObject(forKey :"edges") as? [FollowersEdge]
