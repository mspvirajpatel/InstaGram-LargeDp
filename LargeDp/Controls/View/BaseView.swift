...
//  ViewControllerDemo
//
//  Created by VirajPatel on 24/08/15.
...
class BaseView: UIView {
    ...
    func displayErrorAttributeMessageLabel(_ errorAttributeMessage : NSAttributedString?){
        ...
        AppUtility.executeTaskInMainQueueWithCompletion { [weak self] in
            ...
            if(self!.errorMessageLabel != nil){
                ...
                if(errorAttributeMessage != nil){
                    ...
                    self!.errorMessageLabel.attributedText = errorAttributeMessage
