...
struct FontStyle{
    ...
    static let secondary = "Wrexham-Script"
...
extension Color{
    ...
    var value: UIColor {
        ...
        // TODO: SideMenu Color
        case .sideMenuBG:
            instanceColor = UIColor(rgbValue: 0xffffff)  //2D3238 0x1B3B5B
            break
            
        case .sideMenuText:
            instanceColor = UIColor(rgbValue: 0x2196F3)
            break
            
        case .sideMenuSelectedText:
            instanceColor = UIColor(rgbValue: 0xffffff)
            break
        ...
        case .appPrimaryBG: // this is application general dark backgroud color
            instanceColor = UIColor(rgbValue: 0x71544A, alpha: 1.0)
            break
        ...
        case .buttonPrimaryBG:
            instanceColor = UIColor(rgbValue: 0x2196F3, alpha: 1.0)
            break
