...
//
//
//  Created by VirajPatel on 28/09/16.
//
//
...
enum APITask : String
{
    ...
    case TimeLinePagination = "TimeLine Pagination"
    case MyFollowers = "MyFollowers"
    case MyFollowings = "MyFollowings"
    case Follow = "Follow"
    ...
    case PlaceDetails = "Place Details"
    case Pagination = "Pagination"
    case TagDetails = "Tag Details"
    
    case Logout = "Logout"
    case FeedBack = "FeedBack"
    case SideMenuUser = "SideMenuUser"
    case PostVideoDetail = "VideoDetail"
...
//                print("---------------------")
    ...
    func uploadImage (url: String, Parameter param : NSDictionary, Images arrImage: NSArray, Type type : APITask ,Headers header: HTTPHeaders , completionHandler : @escaping (_ result : Result) -> ()) -> Void
    {
